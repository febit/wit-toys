...
public class ContextMethods implements GlobalRegister {
    ...
    public static final MethodDeclare noop = (context, args) -> null;
    public static final MethodDeclare id = (context, args) -> NEXT_ID.getAndIncrement();
    public static final MethodDeclare now = (context, args) -> System.currentTimeMillis();
